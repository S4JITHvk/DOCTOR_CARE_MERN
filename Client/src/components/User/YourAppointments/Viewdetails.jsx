    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-3/4 md:w-1/2 lg:w-1/3 transform transition-all duration-300 ease-out">
        <div className="flex justify-between items-center border-b pb-3">
          <h2 className="text-xl font-bold text-gray-700">Appointment Details</h2>
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center">
            <span className="font-semibold text-gray-700 w-1/3">Doctor Name:</span>
            <span className="text-gray-900">{appointment.doctorName}</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold text-gray-700 w-1/3">Expertise:</span>
            <span className="text-gray-900">{appointment.expertise}</span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold text-gray-700 w-1/3">Experience:</span>
            <span className="text-gray-900">{appointment.experience} Years</span>
          </div>
          <div className="flex items-center">
          ...
          <div className="flex items-center">
            <span className="font-semibold text-gray-700 w-1/3">Booking Date:</span>
          ...
          <div className="flex items-center">
            ...
            <span className={`text-gray-900 ${appointment.status === "Active" ? "text-blue-500" : appointment.status === "Cancelled" ? "text-red-500" : "text-green-500"}`}>
              {appointment.status === "Active" ? "Upcoming" : appointment.status === "Cancelled" ? "Cancelled" : "Completed"}
            </span>
          </div>
          <div className="flex items-center">
            <span className="font-semibold text-gray-700 w-1/3">Scheduled on:</span>
