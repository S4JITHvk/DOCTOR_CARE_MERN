...
const Sortedreview=review.reviews?.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
  return (
    <Modal
      isOpen={isOpen}
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-[600px]">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center">
              ...
              />
              <div>
                <h2 className="text-xl font-semibold text-blue-800">DR {doctor.name}</h2>
          ...
          <div className="flex">
            <div className="w-1/2 pr-2 border-r">
              <h3 className="text-lg font-semibold mb-4 text-blue-800">Add Review</h3>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 ${
                    reviewText.trim() === "" ? "opacity-50 cursor-not-allowed" : ""
                  }`}
            ...
            <div className="w-1/2 pl-2 overflow-y-auto" style={{ maxHeight: '300px' }}>
              <h3 className="text-lg font-semibold mb-4 text-blue-800">View Reviews</h3>
