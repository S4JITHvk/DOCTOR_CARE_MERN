        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col items-center justify-center mb-6">
            ...
            <div className="flex items-center justify-center mb-4">
              <label
                htmlFor="file-upload"
                className="cursor-pointer bg-blue-500 text-white py-2 px-4 rounded-full shadow-md hover:bg-blue-700 transition duration-300 ease-in-out"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="mb-6">
              <label
                htmlFor="working_Hospital_contact"
                className="block text-gray-700 font-bold mb-2"
              >
                Working Hospital Contact
              </label>
              <input
                type="text"
