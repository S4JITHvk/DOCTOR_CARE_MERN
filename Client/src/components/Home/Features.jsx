export default function Faq() {
  return (
    <>
      <section className="relative z-20 p-10 overflow-hidden bg-black text-text pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[520px] h-[70px] text-center bg-rose-200 rounded-lg p-4">
                <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-black font-serif sm:text-4xl md:text-[40px] pb-5">
                  MIND CARE
                </h2>
              </div>
            </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px] p-5">
                <div className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-pink-500 text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 34 34"
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    There are many other healthcare apps out there. So why
                    choose ours?
                  </h3>
                  <p className="text-base text-white dark:text-dark-6">
                    We are not here to compete with other healthcare apps. Our
                    primary goal is to address the unique challenges faced by
                    individuals seeking medical consultations.our focus is on
                    providing a comprehensive service that includes doctor
                    bookings, chat, video calls, and a safe space to share
              ...
              <div className="mb-12 flex lg:mb-[70px] p-5">
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Is it possible for both male and female users to create
                    accounts?
                  </h3>
                  <p className="text-base text-white dark:text-dark-6">
                    Absolutely! Our app is designed to be inclusive and
                    accessible to everyone, regardless of gender. We believe
                    that everyone deserves access to quality healthcare and the
                    ability to consult with doctors, whether through bookings,
                    chat, or video calls. We are committed to providing a safe
                    and supportive environment for all users to share their
                    feelings and problems.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px] p-5">
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Is the doctor consulting team diverse?
                  </h3>
                  <p className="text-base text-white">
                    Our team is composed of skilled professionals dedicated to
                    providing the best service. We value diversity and
                    inclusion, ensuring that our team listens to and understands
                    the needs of all our patients. By fostering a collaborative
                    environment, we bring a wide range of perspectives to our
                    consultations, aiming to deliver comprehensive and
                    empathetic care.
                  </p>
                </div>
              </div>
              <div className="mb-12 flex lg:mb-[70px] p-5">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-white dark:text-dark-6">
                    No, this is a fully developed and functioning service. While
                    it continues to evolve, we are dedicated to improving it
                    based on user feedback and suggestions. Our aim is to
                    provide a seamless experience for doctor bookings, chats,
                    video calls, and sharing your feelings and problems. We
                    invite you to try it out and share your thoughts with us.
                  </p>
                </div>
              </div>
            </div>
