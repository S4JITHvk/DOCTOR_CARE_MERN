      ...
      <div className="flex min-h-full flex-col justify-center px-10 py-12 lg:px-8" style={{
        ...
        {errormsg && <p className="mt-1 text-center text-red-500 text-lg font-bold">{errormsg}</p>}
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/emailfrom" className="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</Link>
                </div>
              </div>
              <div className="mt-2">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?
            <Link to="/usersignup" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign Up</Link>
          </p>
        </div>
      </div>
    </>
